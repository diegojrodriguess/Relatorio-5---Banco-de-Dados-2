...
class BookModel:
    ...
    def create_book(self, titulo:str, autor:str, ano:int, preco:float):
        try:
            res = self.db.collection.insert_one({"autor": autor, "ano": ano, "titulo" : titulo, "preco" : preco})
    ...
    def update_book(self, id: str, titulo:str, autor:str, ano:int, preco:float):
        try:
            res = self.db.collection.update_one({"_id": ObjectId(id)}, {"$set": {"autor": autor, "ano": ano, "titulo" : titulo, "preco" : preco}})
